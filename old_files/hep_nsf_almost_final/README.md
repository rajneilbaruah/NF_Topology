...
- `r2` works in **normalised coordinates** — data is standardised first, so the Gaussian base is appropriate and the periodic conditions are not applied and hence not **circular**
