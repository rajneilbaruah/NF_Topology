...
rqs
    ...
    Used by AngularSphereFlow (r2) and CartesianNSF (r3).
...
rqs_circular
    ...
    right edge).  Used for the phi dimension in RecursiveSphereFlow (s2)
...
# ---------------------------------------------------------------------------
# 1.  Standard symmetric spline  (r2 and r3 models)
# ---------------------------------------------------------------------------

def rqs(inputs, w, h, d, inverse=False, bound=1.0, eps=1e-6):
    """Standard RQS on [-bound, bound].  Used by r2 and r3 models."""
...
# ---------------------------------------------------------------------------
# 3.  Circular / periodic spline  (phi dimension of s2 model)
# ---------------------------------------------------------------------------
